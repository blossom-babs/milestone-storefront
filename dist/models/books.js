      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            error_3 = _a.sent();
            throw new Error(
              "Could not get book with id ".concat(id, ": ").concat(error_3)
            );
          case 4:
            return [2 /*return*/];
        }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            error_4 = _a.sent();
            throw new Error(
              "Could not delete book with id ".concat(id, ": ").concat(error_4)
            );
          case 4:
            return [2 /*return*/];
        }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            conn = _a.sent();
            sql =
              "UPDATE books SET title=($1), author=($2), total_pages=($3), category=($4), summary=($5) WHERE id=".concat(
                id,
                " RETURNING *"
              );
            bookValues = Object.values(book);
