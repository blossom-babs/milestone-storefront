    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                res
                    .status(200)
                    .json({ message: "Could not fetch product with error ".concat(error_2) });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
var destroy = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_4 = _a.sent();
                throw new Error("Could not retrieve product: ".concat(error_4));
            case 3: return [2 /*return*/];
        }
    });
}); };
var category = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var cat, result, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
            ...
            case 2:
                error_5 = _a.sent();
                throw new Error("Could not retrieve product: ".concat(error_5));
            case 3: return [2 /*return*/];
        }
    });
}); };
