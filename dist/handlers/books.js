...
var bookStore = new books_1.BookStore();
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var book, result, error_1;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, bookStore.show(id)];
            case 1:
                result = _a.sent();
                if (result === undefined) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                book = req.body;
                id = req.params.id;
                return [4 /*yield*/, bookStore.update(id, book)];
            case 1:
                result = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, bookStore["delete"](id)];
            case 1:
                result = _a.sent();
                res.status(200).json(result);
                return [3 /*break*/, 3];
            case 2:
                error_5 = _a.sent();
                throw new Error("Could not retrieve book: ".concat(error_5));
            case 3: return [2 /*return*/];
        }
    });
}); };
